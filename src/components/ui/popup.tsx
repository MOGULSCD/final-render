          ...
          <div className="space-y-12 sm:space-y-16">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                <h1 className={cn("text-3xl sm:text-5xl font-black leading-tight tracking-tight", styles.textGradient)}>
                  MOGULS
                </h1>
                <div className={styles.accentLine} />
                <h2 className="text-xl sm:text-3xl font-light leading-tight" style={{ color: 'var(--color-text-primary)' }}>
                  The First Operating System for Creators.
                </h2>
                <p className="text-base sm:text-xl leading-relaxed font-light" style={{ color: 'var(--color-text-secondary)' }}>
                  Your brand. Your business. Your community. Finally in one place.
                </p>
              </div>
              <button 
                onClick={handleClaimSpot}
                className={cn(styles.buttonCTA, "px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg")}
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                <h2 className="text-xl sm:text-2xl font-semibold" style={{ color: 'var(--color-text-primary)' }}>What That Means</h2>
                <div className={styles.accentLine} />
                
                <div className={styles.contentCard}>
                  <p className="text-base sm:text-lg leading-relaxed font-light mb-4" style={{ color: 'var(--color-text-secondary)' }}>
                ...
                <div className={styles.featureList}>
                  <div className={cn(styles.featureItem, "font-light text-sm sm:text-base")} style={{ color: 'var(--color-text-tertiary)' }}>
