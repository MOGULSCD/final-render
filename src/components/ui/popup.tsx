      ...
      >
        <div className="p-6 text-white">
          ...
          <div className="space-y-6">
            ...
            >
              <h1 className="text-4xl font-black leading-tight tracking-wider">
                MOGULS
              </h1>
              ...
              <Button className="bg-gradient-to-r from-orange-400 to-pink-500 text-white px-6 py-3 rounded-full font-semibold hover:opacity-90 hover:scale-105 transition-all duration-200 ease-out">
                Claim Your Spot
              </Button>
            </div>
            ...
            >
              <h2 className="text-xl font-black text-white">What That Means</h2>
              <div className="space-y-3">
                ...
                <ul className="space-y-1.5 text-white/90 ml-4 text-sm font-medium">
            ...
            <div 
              className={cn(
                "space-y-3 transition-all duration-700 ease-out transform",
                isOpen ? "translate-y-0 opacity-100" : "translate-y-[20px] opacity-0"
              )}
              style={{ transitionDelay: isOpen ? "800ms" : "0ms" }}
            >
              <h2 className="text-xl font-black text-white">MogulLens AI</h2>
              <div className="space-y-2">
                <p className="text-base text-white/90 font-bold">Your built-in strategist.</p>
                <p className="text-white/90 leading-relaxed text-sm font-medium">
            ...
            >
              <h2 className="text-xl font-black text-white">Monetization Without Limits</h2>
              <div className="space-y-2">
                <p className="text-base text-white/90 font-bold">Sell anything. Bundle everything. Accept fiat or crypto.</p>
                <p className="text-white/90 leading-relaxed text-sm font-medium">
            ...
            >
              <h2 className="text-xl font-black text-white">Why Moguls</h2>
              <div className="space-y-2">
                <p className="text-base text-white/90 font-bold">Not a link. Not another platform.</p>
                <p className="text-white/90 leading-relaxed text-sm font-medium">
            ...
            >
              <div className="space-y-3">
                <h2 className="text-xl font-black text-white">Everything you are. One OS.</h2>
